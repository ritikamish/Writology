let blog = JSON.parse(localStorage.getItem("selectBlog")) || false
...
function displayGraph(blog) {
    ...
    blog.reactions.forEach((reaction) => {
        ...
        bar.style.height =  reaction.count*40 + "px"
        bar.style.width = "50px"
      bar.innerHTML = reaction.emoji
       
        bars.append(bar,)
    })
    
    analytics.append(bars,  blog.title)
}
